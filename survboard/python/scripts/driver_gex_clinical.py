    ...
    for cancer in cancers:
        ...
        for outer_split in range(25):
            ...
            if setting != "pancancer":
                ...
                X_train = [[i for i in X_train.columns if i.rsplit("_")[0] in ["gex", "clinical"]]]
                X_test = [[i for i in X_test.columns if i.rsplit("_")[0] in ["gex", "clinical"]]]
            else:
                for cancer in config["tcga_cancers"]:
                ...
                if setting != "pancancer":
                    ...
                    sf_df.to_csv(
                        os.path.join(
                            ...
                            project,
                            cancer,
                            f"{model_name}_{setting}_gex_clinical",
