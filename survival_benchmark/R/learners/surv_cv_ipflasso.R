...
LearnerSurvIpflasso <- R6Class("LearnerSurvGrpreg",
  ...
  public = list(
    ...
    initialize = function() {
      ps <- ps(
        alpha = p_dbl(0, 1, default = 0, tags = "train"),
        type.step1 = p_fct(c("comb", "sep"), default = "comb", tags = "train"),
        nfolds = p_int(3, 10, default = 5, tags = "train"),
        ncv = p_int(3, 10, default = 5, tags = "train"),
