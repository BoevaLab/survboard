            ...
            for project in ["validation"]:
                for cancer in ["PAAD", "LIHC"]:
                    ...
                    for outer_split in range(25):
                        ...
                        X_test = X_test_overall.drop(columns=["OS", "OS_days"])
                        X_train = (
                        ...
                        net = SKORCH_NET_FACTORY["cox_sgl"](
                            module=(SKORCH_MODULE_FACTORY[model_type]),
                            criterion=(CRITERION_FACTORY["cox_sgl"]),
